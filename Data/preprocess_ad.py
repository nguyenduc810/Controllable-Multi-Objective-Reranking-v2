...
# appending a path 
sys.path.append('/home/ubuntu/duc.nm195858/Controllable-Multi-Objective-Reranking-v2') 
...
if __name__ == '__main__':
    # parameters
    random.seed(1234)
    raw_data_dir = '/home/ubuntu/duc.nm195858/Controllable-Multi-Objective-Reranking/Data/'
    data_dir = '/'
    data_set_name = 'ad'
    # raw_data_dir = ''
    # data_set_name = '.'
    ...
    processed_dir = os.path.join(raw_data_dir, data_set_name + '/processed/')
